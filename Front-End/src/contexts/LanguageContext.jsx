  ...
  const translations = {
    ar: {
      ...
      common: {
        ...
        tryDifferentFilters: "جرب تصفية مختلفة أو ابحث عن شيء آخر",
        showing: "عرض",
        of: "من",
        initiatives: "مبادرات",
        articles: "مقال",
      ...
      home: {
        ...
        description:
          "يعمل البرنامج على تنظيم وتمكين الجهود المشتركة بين الجهات الحكومية والقطاع غير الربحي والمجتمع المحلي، بما يسهم في تحقيق بيئة صحية مستدامة ورفع كفاءة المؤشرات الصحية والتنموية بالمحافظة.",
        healthInitiatives: "مبادرة",
        activeVolunteers: "متطوع",
      ...
      about: {
        ...
        description:
          "برنامج مدينة حريملاء الصحية هو برنامج وطني تنموي وصحي يُعنى بتطبيق معايير المدن الصحية بمحافظة حريملاء. يعمل البرنامج ضمن إطار برنامج المدن الصحية بالمملكة العربية السعودية، من خلال منظومة تشاركية متكاملة تضم الجهات الحكومية والأهلية والخاصة والمجتمع المحلي .\n\nسُجلت محافظة حريملاء رسميًا ضمن برنامج المدن الصحية بتاريخ 30 نوفمبر 2021م، ومنذ ذلك الحين يعمل البرنامج على تنظيم وتمكين الجهود المشتركة، وتعزيز المبادرات النوعية، ورفع كفاءة المؤشرات الصحية والتنموية، بما يسهم في تحسين جودة الحياة وتحقيق الاستدامة المجتمعية .\n\nيعمل البرنامج تحت إشراف سعادة محافظ حريملاء رئيس اللجنة الرئيسية، وبدعم وتنسيق من مكتب التنسيق، وبمشاركة 18 جهة حكومية وأهلية وخيرية، يتم تنفيذ الأعمال من خلال لجان متخصصة تتولى تنفيذ المبادرات، ومتابعة المؤشرات، ورفع الشواهد، واستكمال متطلبات الاعتماد لضمان بيئة مستدامة ووعي صحي شامل .",
        vision: {
          title: "رؤيتنا",
          description:
      ...
      quickLinksSection: {
        ...
        links: {
          ...
          login: "تسجيل الدخول",
          shareSuccessStory: "شاركنا قصة نجاح",
        },
      ...
      footer: {
        ...
        copyright: "جميع الحقوق محفوظة لمدينة حريملاء الصحية © 2022 - 2026",
        madeWith: "صنع بـ",
      ...
      standardsManagement: {
        ...
        rejected: "تحتاج مراجعة",
        didntSubmit: "قيد الاستكمال",
    ...
    en: {
      ...
      common: {
        loading: "Loading...",
        search: "Search",
        tryDifferentFilters: "Try different filters or search for something else",
        filter: "Filter",
        sort: "Sort",
        all: "All",
        newest: "Newest",
      ...
      home: {
        ...
        description:
          "The program organizes and empowers collaborative efforts between government bodies, the non-profit sector, and the local community, contributing to a sustainable healthy environment and enhancing the efficiency of health and development indicators in the governorate.",
        healthInitiatives: "Initiative",
      ...
      about: {
        ...
        description:
          "The Huraymila Healthy City Program is a national developmental and health initiative dedicated to implementing healthy city standards in the Huraymila Governorate. The program operates within the framework of the Saudi Healthy Cities Program through an integrated collaborative framework involving governmental, non-profit, private, and local community sectors.\n\nHuraymila Governorate was officially registered under the Healthy Cities Program on November 30, 2021. Since then, the program has worked to organize and empower collaborative efforts, promote qualitative initiatives, and enhance the efficiency of health and developmental indicators, contributing to improving quality of life and achieving community sustainability.\n\nThe program operates under the supervision of His Excellency the Governor of Huraymila, Chairman of the Main Committee, with support and coordination from the Coordination Office, and with the participation of 18 governmental, non-profit, and charitable organizations. The work is executed through specialized committees responsible for implementing initiatives, tracking indicators, uploading evidence, and completing accreditation requirements to ensure a sustainable environment and comprehensive health awareness.",
        vision: {
          title: "Our Vision",
          description:
      ...
      quickLinksSection: {
        ...
        links: {
          ...
          login: "Login",
          shareSuccessStory: "Share Your Success Story",
        },
      ...
      footer: {
        ...
        copyright:
          "All rights reserved for Huraymila Healthy City © 2022 - 2026",
        madeWith: "Made with",
