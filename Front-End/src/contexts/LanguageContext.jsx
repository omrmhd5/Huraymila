  ...
  const translations = {
    ar: {
      ...
      nav: {
        ...
        healthyCity: "محافظة حريملاء الصحية",
      },
      ...
      // About Section
      about: {
        title: "عن برنامج محافظة حريملاء الصحية",
        subtitle: "مبادرة وطنية رائدة ضمن برنامج المدن الصحية السعودي",
        description:
          "برنامج محافظة حريملاء الصحية هو مبادرة وطنية طموحة تهدف إلى تحويل محافظة حريملاء إلى نموذج متقدم للمدن الصحية في المملكة العربية السعودية، من خلال تطبيق أحدث المعايير العالمية وأفضل الممارسات في مجال الصحة المجتمعية والتنمية المستدامة.",
        vision: {
          title: "رؤيتنا",
          description:
            "أن تكون حريملاء محافظة صحية نموذجية تحقق أعلى معايير جودة الحياة لسكانها وزوارها، وتساهم في تحقيق رؤية المملكة 2030.",
        },
        mission: {
          title: "رسالتنا",
          description:
        ...
        objectives: {
          ...
          list: [
            ...
            "زيادة المساحات الخضراء في المحافظة إلى 40% من إجمالي المساحة",
            "توعية 80% من سكان المحافظة بثقافة الصحة والبيئة",
      ...
      aboutHuraymila: {
        ...
        description:
          "تقع محافظة حريملاء في منطقة الرياض شمال غرب محافظة الرياض على بعد 86 كيلومتراً. تتميز بموقعها الاستراتيجي وتراثها العريق وتشتهر بالزراعة والمواقع التاريخية.",
        history: {
      ...
      initiatives: {
        title: "المبادرات",
        subtitle: "اكتشف المبادرات النشطة في محافظة حريملاء الصحية",
        ...
        urbanGreeningDesc:
          "مبادرة لزيادة المساحات الخضراء في المحافظة وتحسين جودة الهواء",
        healthyWalking: "مبادرة المشي الصحي",
        healthyWalkingDesc: "برنامج أسبوعي للمشي الصحي في منتزهات المحافظة",
        ...
        cityHealthCenter: "مركز المحافظة الصحي",
        throughoutCity: "جميع أنحاء المحافظة",
        cityPark: "منتزه المحافظة",
      ...
      successStories: {
        title: "قصص النجاح",
        subtitle: "اكتشف كيف غيرت مبادرتنا حياة الناس في محافظة حريملاء",
        description:
      ...
      newsSection: {
        title: "أحدث الأخبار",
        subtitle: "تابع آخر التحديثات والمبادرات في محافظة حريملاء الصحية",
        description:
      ...
      news: {
        title: "الأخبار",
        subtitle: "تابع آخر الأخبار والتطورات في محافظة حريملاء الصحية",
        ...
        technology: "تقنية",
        preventiveHealth: "إطلاق مبادرة الصحة الوقائية في محافظة حريملاء",
        ...
        walkingProgramDesc:
          "برنامج أسبوعي للمشي الصحي في منتزهات المحافظة مع مرشدين مختصين",
      ...
      contact: {
        ...
        contactInformationDesc:
          "طرق مختلفة للتواصل مع فريق مبادرة المحافظة الصحية",
        ...
        addressContactDesc: "موقع مبادرة المحافظة الصحية",
        address: "محافظة حريملاء، الرياض، المملكة العربية السعودية",
      ...
      faq: {
        ...
        subtitle:
          "إجابات على أكثر الأسئلة شيوعاً حول برنامج محافظة حريملاء الصحية",
        ...
        whatIsProgram: "ما هو برنامج محافظة حريملاء الصحية؟",
        whatIsProgramAnswer:
          "برنامج محافظة حريملاء الصحية هو مبادرة شاملة تهدف إلى تحسين جودة الحياة والصحة العامة في محافظة حريملاء من خلال تعزيز التعاون بين الجهات الحكومية والجمعيات الأهلية والمجتمع المحلي.",
        ...
        visitUs: "زرنا",
        visitUsDetails: "مكتب تنسيق برنامج المحافظة الصحية",
      ...
      footer: {
        description:
          "مبادرة محافظة حريملاء الصحية هي مشروع وطني يهدف إلى تعزيز الصحة العامة وتحسين جودة الحياة في المحافظة من خلال مجموعة من البرامج والمبادرات المتنوعة.",
        quickLinks: "روابط سريعة",
        contactInfo: "معلومات التواصل",
        address: "محافظة حريملاء، منطقة الرياض، المملكة العربية السعودية",
        ...
        copyright: "© 2025 مبادرة محافظة حريملاء الصحية. جميع الحقوق محفوظة.",
        madeWith: "صنع بـ",
      ...
      aboutPage: {
        title: "من نحن",
        subtitle: "مبادرة محافظة حريملاء الصحية",
        description:
          "نحن مبادرة وطنية تهدف إلى تعزيز الصحة العامة وتحسين جودة الحياة في محافظة حريملاء من خلال مجموعة من البرامج والمبادرات المتنوعة.",
        mission: "مهمتنا",
        missionText:
          "تعزيز الصحة العامة وتحسين جودة الحياة في محافظة حريملاء من خلال المبادرات المجتمعية والشراكات الاستراتيجية.",
        vision: "رؤيتنا",
        visionText:
          "أن تكون محافظة حريملاء نموذجاً للمحافظة الصحية المستدامة في المملكة العربية السعودية.",
        values: "قيمنا",
        valuesList: [
          "الشفافية والمصداقية",
          "الشراكة المجتمعية",
        ...
        goalsList: [
          "تحسين مؤشرات الصحة العامة في المحافظة بنسبة 30% خلال 3 سنوات",
          "زيادة المساحات الخضراء في المحافظة إلى 40% من إجمالي المساحة",
          "توعية 80% من سكان المحافظة بالثقافة الصحية والبيئية",
          "تطوير 20 مبادرة صحية جديدة سنوياً",
      ...
      report: {
        title: "تقديم بلاغ",
        subtitle:
          "شاركنا ملاحظاتك وبلاغاتك لتحسين الخدمات في محافظة حريملاء الصحية",
        back: "العودة",
      ...
      standards: [
        ...
        },
        {
          number: 2,
          standard:
            "تم تشكيل لجنة تنسيق المحافظة الصحية، وتسجيلها لدى السلطات المحلية باعتبارها منظمة مجتمعية أو منظمة غير حكومية، وتم توجيه الأعضاء بشأن مهامهم ومسؤولياتهم.",
          requirements: [
        ...
        },
        {
          number: 4,
          standard:
            "إشراف مراقبو لجنة تنسيق المحافظة الصحية على المشاريع الاجتماعية والاقتصادية، وسجلات الإنجازات والمُعوقات ويحددون الحلول المحلية للمشكلات المحلية.",
          requirements: [
        ...
        },
        {
          number: 5,
          standard:
            "ه تبحث لجنة تنسيق المحافظة الصحية عن الموارد وتبني علاقات مع الشركاء المحتملين لمزيد من التنمية في مناطقهم المحلية.",
          requirements: [
        ...
        },
        {
          number: 8,
          standard:
            "تم ترشيح أعضاء لجنة تنسيق المحافظة الصحية رسمياً من قبل مختلف القطاعات ذات الصلة بالمعايير.",
          requirements: ["بيان بالمنسقين رسمياً من مختلف القطاعات"],
        },
        {
          number: 9,
          standard:
            "تم تشكيل لجنة تنسيق المحافظة الصحية تحت قيادة رئيس بلدية أو محافظ، وتضع أعضاءها من ممثلي جميع القطاعات ذات الصلة. ويتم تسجيل محاضر جميع الاجتماعات وإعداد تقارير بها.",
          requirements: [
        ...
        },
        {
          number: 10,
          standard:
            "تم تعيين منسق رسمي لبرنامج المحافظة الصحية وتوفير عدد كاف من الموظفين والحيز المادي والمرافق.",
          requirements: [
            "قرار تعيين منسق برنامج المحافظة الصحية",
        ...
        },
        {
          number: 11,
          standard:
            "يجتمع أعضاء فريق القطاعات المشتركة مع لجنة تنسيق المحافظة الصحية وتقديم المشورة الفنية والدعم للمجتمع.",
          requirements: ["تقارير الاجتماعات"],
        },
        {
          number: 12,
          standard:
            "تم تحديد الشركاء المحتملين والاتصال بهم ويجري العمل على مشروع مشترك واحد على الأقل مع الشركاء في موقع تنفيذ المحافظة الصحية.",
          requirements: [
            "بيان بشركاء برنامج المحافظة الصحية",
        ...
        },
        {
          number: 15,
          standard:
            "تم تحديد ذوي الاحتياج في المجتمع وفقاً لمعايير محددة وافق عليها فريق تنسيق المحافظة وتعطى الأولوية لهم في توفير القروض المدرة للدخل.",
          requirements: [
        ...
        },
        {
          number: 17,
          standard:
            "تم تسجيل جميع القضايا المالية ومتابعتها من قبل أمين الشؤون المالية في لجنة تنسيق المحافظة الصحية.",
          requirements: [
            "سجلات القضايا المالية لتوضيح المتابعه من قبل المنسق المالي للجنة المحافظة الصحية.",
          ],
        },
        {
          number: 18,
          standard:
            "تم تسديد القروض على أساس منتظم، وتم وضع آلية متابعة من قبل لجنة تنسيق المحافظة الصحية أو النظام المصرفي المحلي في المكان.",
          requirements: ["بيان بآليات المتابعه"],
        },
        {
          number: 19,
          standard:
            "تم فتح حساب مصرفي للجنة تنسيق المحافظة الصحية أو مكتب البرنامج وتذهب جميع التفاعلات المالية المتعلقة بالقروض الصغيرة من خلال البنوك ذات الصلة. منسق البرنامج والمجتمع يدركون ذلك جيداً.",
          requirements: [
            "بيانات الحساب المصرفي لمكتب تنسيق برنامج المحافظة الصحية وشفاف لكافة اللجان.",
        ...
        },
        {
          ...
          requirements: [
            ...
            "بيان بهيئات الاعتماد والمدارس الحاصلة علي الاعتماد في مواقع تنفيذ برنامج المحافظة الصحية",
          ],
        },
        {
          number: 25,
          ...
          requirements: [
            ...
            "محاضر الاجتماعات مع مكتب تنسيق برنامج المحافظة الصحية.",
          ],
        },
        {
          number: 26,
        ...
        },
        {
          number: 29,
          standard:
            "أنشأت لجنة تنسيق المحافظة الصحية، بالتعاون مع مزودي خدمات الرعاية الصحية، نظم الإحالة المستدامة.",
          requirements: [
        ...
        },
        {
          number: 31,
          standard:
            "تم تشكيل لجنة فرعية تابعة للجنة تنسيق المحافظة الصحية لإدارة والإشراف على خدمات الرعاية الصحية المحلية.",
          requirements: [
            "قرار تشكيل اللجنة الفرعية التابعة للجنة تنسيق المحافظة الصحية لإدارة والإشراف على خدمات الرعاية الصحية المحلية",
          ],
        },
        {
          number: 32,
        ...
        },
        {
          number: 38,
          standard:
            "لجنة تنسيق المحافظة الصحية وممثلو المجتمع ومتطوعو الصحة يشاركون بنشاط في حملات شلل الأطفال في حال تم إجراء أي منها.",
          requirements: ["بيان بما يفيد"],
        },
        {
          number: 39,
        ...
        },
        {
          number: 55,
          standard:
            "تم تعيين وحماية مصادر المياه. تم وضع خطة لمعالجة المياه، ولجنة تنسيق المحافظة الصحية على علم بذلك.",
          requirements: ["بيان بما يفيد"],
        },
        {
          number: 56,
        ...
        },
        {
          number: 60,
          standard:
            "يحظر التدخين في األماكن المغلقة واألماكن العامة، وقد تم وضع واعتماد إنشاء محافظة خالية من التدخين.",
          requirements: [
        ...
        },
        {
          number: 61,
          standard:
            "تم تأسيس مركز إلدارة نوعية على األساس المجتمعي في موقع تنفيذ برنامج المحافظة الصحية (يشمل البلدية) لضمان أن يتم الرصد المنظم لتلوث الهواء. يدرك المجتمع مخاطر تلوث الهواء.",
        ...
        },
        {
          number: 65,
          standard:
            "يتم عرض المعلومات الرئيسية في مركز المعلومات المجتمعية أو المكتب المحلي لبرنامج المحافظة الصحية ومشاركتها مع المجتمع والقطاعات/ الشركاء اآلخرين المعنيين.",
          requirements: [
        ...
        },
        {
          number: 67,
          standard:
            "أشكال ونتائج المسح األساسي والمعلومات بشأن المشاريع الحالية موثقة توثيقا ً جيداً حتى اآلن ومتوفرة لدى لجنة تنمية المجتمع المحلي ومركز تنسيق المحافظة الصحية.",
          requirements: ["التقارير ذات الصلة"],
        },
        {
          number: 68,
          standard:
            "تم إنشاء ملف تعريف للمحافظة، ويتم تحديثه واستخدامه بانتظام ألغراض التخطيط والرصد.",
        ...
        },
        {
          number: 71,
          standard:
            "لجنة تنسيق المحافظة الصحية تعطي األولوية لتوفير قروض صغيرة لطالب مراكز التدريب المهني.",
          requirements: ["بيان بما يفيد"],
        },
        {
          number: 72,
        ...
        },
        {
          number: 77,
          standard:
            "تم تطوير ملف تعريف للمحافظة وتم االحتفاظ بنسخة من هذا الملف خارج منطقة تنفيذ البرنامج.",
