...
export const LanguageProvider = ({ children }) => {
  ...
  const translations = {
    ar: {
      ...
      footer: {
        description:
          "مبادرة مدينة حريملاء الصحية هي مشروع وطني يهدف إلى تعزيز الصحة العامة وتحسين جودة الحياة في المحافظة من خلال مجموعة من البرامج والمبادرات المتنوعة.",
      ...
      standardsManagement: {
        ...
        viewDetailedSubmissions: "عرض الشواهد التفصيلية",
      },
      submissionsView: {
        ...
        images: "صور",
        videos: "فيديوهات",
        totalSubmissions: "إجمالي الشواهد",
        approved: "تمت الموافقة",
        pendingApproval: "في انتظار الموافقة",
        rejected: "مرفوض",
        acceptanceRate: "نسبة القبول",
        submittedMaterials: "الشواهد المقدمة",
        ...
        submissionsWillAppearHere: "ستظهر الشواهد هنا",
        view: "عرض",
        approve: "موافقة",
        reject: "رفض",
      ...
      requiredStandards: {
        title: "ملخص المعايير المطلوبة",
        subtitle: "المعايير المخصصة للجنة وحالة التنفيذ",
        assignedStandards: "المعايير المخصصة",
        assignedStandardsDesc: "قائمة بالمعايير التي يجب على اللجنة تنفيذها",
        all: "الكل",
        approved: "معتمد",
        rejected: "مرفوض",
        ...
        video: "فيديو",
        undefined: "غير محدد",
        noStandardsMatch: "لا توجد معايير تطابق البحث",
        viewSubmission: "عرض التقديم",
        editSubmission: "تعديل التقديم",
        addSubmission: "إضافة تقديم",
        submissionAdded: "تم إضافة التقديم بنجاح",
        submissionUpdated: "تم تحديث التقديم بنجاح",
        errorSaving: "خطأ أثناء حفظ التقديم",
      },
