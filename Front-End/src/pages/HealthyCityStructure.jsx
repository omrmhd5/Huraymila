...
const orgStructure = {
  ...
  root: {
    main_committee_chair: ["رئيس اللجنة الرئيسية", "منسق مدينة حريملاء الصحية"],
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12 max-w-4xl mx-auto">
          <p
            ...
            حريملاء محافظة صحية، حيث يتولى منسق مدينة حريملاء الصحية رئاسة اللجنة الرئيسية،
            ويتفرع منها ثلاث محاور أساسية تشمل اللجان الفرعية، اللجان الداعمة،
            وجميع اللجان الشريكة التي تعمل بشكل متكامل لتحقيق رؤية المحافظة
            الصحية.
          </p>
        </div>
