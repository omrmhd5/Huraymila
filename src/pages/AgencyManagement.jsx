...
const AgencyManagement = () => {
  ...
  const getTypeBadge = (type) => {
    switch (type) {
      case "health":
        return <Badge variant="outline" className="bg-blue-50 text-blue-700">صحة</Badge>;
      case "municipality":
        return <Badge variant="outline" className="bg-green-50 text-green-700">بلدية</Badge>;
      case "education":
        return <Badge variant="outline" className="bg-purple-50 text-purple-700">تعليم</Badge>;
      default:
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-4xl font-bold text-primary mb-2">إدارة الوكالات</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">إجمالي الوكالات</p>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">معدل النشاط</p>
                    ...
                    <div key={agency.id} className="border rounded-lg p-4">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <p className="text-muted-foreground mb-3">{agency.description}</p>
                          ...
                          <div className="flex items-center gap-4 mt-3 text-sm text-muted-foreground">
                            ...
                            <span className="flex items-center gap-1">
                              ...
                              {new Date(agency.createdAt).toLocaleDateString('ar-SA')}
                            </span>
                          </div>
                        </div>
                        
                        <div className="flex items-center gap-2 ml-4">
                          <Button variant="outline" size="sm" onClick={() => handleEdit(agency)}>
                            <Edit className="w-4 h-4" />
                          </Button>
                          <Button variant="outline" size="sm">
                            <Eye className="w-4 h-4" />
                          </Button>
                          <Button variant="outline" size="sm" onClick={() => handleDelete(agency.id)}>
          ...
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
            <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto">
              <CardHeader>
                ...
                <CardDescription>
                  {editingAgency ? "تحديث بيانات الوكالة" : "إدخال بيانات الوكالة الجديدة"}
                </CardDescription>
              </CardHeader>
              <CardContent>
